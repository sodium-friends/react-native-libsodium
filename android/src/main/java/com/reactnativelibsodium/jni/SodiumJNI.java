...
public class SodiumJNI {
  ...
  public final static native int crypto_core_ed25519_from_uniform(byte[] jarg1, byte[] jarg2);
  ...
  public final static native int crypto_scalarmult_ed25519_base_noclamp(byte[] jarg1, byte[] jarg2);
