...
function crypto_secretbox_easy(...args) {
  const res = new Uint8Array(Libsodium.crypto_secretbox_easy(...Array.from(args, mapArgs)))
  args[0].set(res)
}
...
function crypto_aead_xchacha20poly1305_ietf_keygen(k) {
  k.set(new Uint8Array(Libsodium.crypto_aead_xchacha20poly1305_ietf_keygen(Array.from(k))))
}

function crypto_aead_xchacha20poly1305_ietf_encrypt(...args) {
  const nativeResult = Libsodium.crypto_aead_xchacha20poly1305_ietf_encrypt(...Array.from(args, mapArgs))
...
function crypto_aead_xchacha20poly1305_ietf_decrypt(...args) {
  const nativeResult = Libsodium.crypto_aead_xchacha20poly1305_ietf_decrypt(...Array.from(args, mapArgs))
...
function crypto_core_ed25519_add (...args) {
  const nativeResult = Libsodium.crypto_core_ed25519_add(...Array.from(args, mapArgs))
...
function crypto_core_ed25519_sub (...args) {
  const nativeResult = Libsodium.crypto_core_ed25519_sub(...Array.from(args, mapArgs))
...
function crypto_core_ed25519_from_uniform (...args) {
  const nativeResult = Libsodium.crypto_core_ed25519_from_uniform(...Array.from(args, mapArgs))
...
function crypto_pwhash (...args) {
  const nativeResult = Libsodium.crypto_pwhash(...Array.from(args.slice(0, 3), mapArgs), ...args.slice(3))
...
function crypto_scalarmult_ed25519 (...args) {
  const nativeResult = Libsodium.crypto_scalarmult_ed25519(...Array.from(args, mapArgs))
...
function crypto_scalarmult_ed25519_noclamp (...args) {
  const nativeResult = Libsodium.crypto_scalarmult_ed25519_noclamp(...Array.from(args, mapArgs))
...
function crypto_scalarmult_ed25519_base (...args) {
  const nativeResult = Libsodium.crypto_scalarmult_ed25519_base(...Array.from(args, mapArgs))
...
function crypto_scalarmult_ed25519_base_noclamp (...args) {
  const nativeResult = Libsodium.crypto_scalarmult_ed25519_base_noclamp(...Array.from(args, mapArgs))
...
function crypto_generichash_init (...args) {
  const nativeResult = Libsodium.crypto_generichash_init(...Array.from(args.slice(0, 2), mapArgs), args[2])
...
function crypto_generichash_update (...args) {
  const nativeResult = Libsodium.crypto_generichash_update(...Array.from(args, mapArgs))
...
function crypto_generichash_final (...args) {
  const nativeResult = Libsodium.crypto_generichash_final(...Array.from(args, mapArgs))
...
function crypto_kdf_keygen (...args) { 
  args[0].set(new Uint8Array(Libsodium.crypto_kdf_keygen(...Array.from(args, mapArgs))))
}

function crypto_kdf_derive_from_key (...args) {
  const nativeResult = Libsodium.crypto_kdf_derive_from_key(mapArgs(args[0]), args[1], ...Array.from(args.slice(2), mapArgs))
